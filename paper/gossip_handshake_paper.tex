...
density parameters ($10$--$16\%$ overall);
...
This is \emph{below the 25\% random-keyword baseline}
...
interference that makes the model \emph{actively worse} than chance.
...
A particularly striking finding emerges from our pilot study:
\emph{stronger specialisation worsens merging}.
Weakly trained specialists (agronomy: 18\%, veterinary: 72\%)
